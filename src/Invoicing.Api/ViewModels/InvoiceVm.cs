...
public record InvoiceVm(
    ...
    Guid? Id,
    [property: JsonPropertyName("date_issued")]
    DateTime DateIssued,
    [property: JsonPropertyName("net_amount")]
    float NetAmount,
    [property: JsonPropertyName("vat_amount")]
    float VatAmount,
    ...
    [property: JsonPropertyName("counter_party_company_id")]
